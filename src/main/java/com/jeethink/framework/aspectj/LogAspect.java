package com.jeethink.framework.aspectj;
...
import com.jeethink.framework.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.jeethink.framework.aspectj.lang.annotation.Log)")
